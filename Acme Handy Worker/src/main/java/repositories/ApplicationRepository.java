...
public interface ApplicationRepository extends JpaRepository<Application, Integer> {
	...
	Collection<Application> getApplicationsByHandyWorker(int handyWorkerId);

	@Query("select a from Application a where a.fixupTask.id = ?1")
	Collection<Application> getApplicationsByFixupTask(int fixupTaskId);
	...
	Double getApplicationsRejectedRatio();
	...
	Double getApplicationsPeriodElapsedRatio();
