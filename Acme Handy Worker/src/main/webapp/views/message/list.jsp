...
<jstl:if test="${isPrincipalAuthorizedEdit}">
	...
	<display:table name="messages" id="row" requestURI="${requestURI}"
		...
		<display:column property="subject" titleKey="message.subject" sortable="false"></display:column>
		
		<display:column property="body" titleKey="message.body" sortable="false"></display:column>
	
		<display:column titleKey="message.priority" sortable="false">
			<spring:message code="message.${row.priority}" />
		</display:column>
		
		<display:column property="tags" titleKey="message.tags" sortable="false"></display:column>
		
		<display:column property="sender.name" titleKey="message.sender" sortable="false"></display:column>
	
		<display:column property="receiver.name" titleKey="message.receiver" sortable="false"></display:column>
